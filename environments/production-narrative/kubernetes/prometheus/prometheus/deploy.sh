...
echo "Pause 30 seconds to let accounts and configmaps update..."
sleep 30
...
kubectl apply -f production-prometheus-narrative-cloud-ingress.yml
kubectl apply -f production-prometheus-federation-narrative-cloud-ingress.yml
