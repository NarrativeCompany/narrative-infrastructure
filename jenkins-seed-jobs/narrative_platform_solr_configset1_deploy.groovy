pipelineJob("narrative-platform-solr-configset1-deploy") {
  properties {
    disableConcurrentBuilds()
  }
	description("Deploys the latest configset1 to Solr/Zookeeper (stopwords, schema, solrconfg). This job should rarely be run manually, and is usually run by narrative-platform-deploy.")
	...
	parameters {
		...
		choiceParam("ENVIRONMENT", ["auto", "dev", "staging"], "The environment to deploy to. Defaults to auto.")
