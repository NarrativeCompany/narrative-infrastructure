pipelineJob("narrative-platform-downtime-deploy") {
  properties {
    disableConcurrentBuilds()
  }
  description("Runs a downtime deployment against an environment. This will put up a system-update page placeholder, shutdown the Narrative site, run a narrative-core container (to update the database if needed), and once updated, will put the Narrative platform back into place.")
  ...
  parameters {
    ...
    choiceParam('ENVIRONMENT', ['dev', 'staging'], 'The environment to deploy to.')
